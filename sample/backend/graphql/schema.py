...
The schema is constructed here from three root types:
  - Query      — all read operations (imported from graphql/query.py)
  - Mutation   — all write operations (imported from graphql/mutation.py)
  - Subscription — all real-time subscriptions (imported from graphql/subscription.py)
...
The schema object is imported by:
  ...
  - manage.py command   → export_schema writes graphql/schema.graphql for codegen
